<template>
    <div id="editorCanvas">
        ...
        <div class="button-menu">
            ...
            <button @click="executeEditorData">Refresh</button>
        </div>
    </div>
</template>
...
export default {
    ...
    mounted() {
        const elements = document.querySelectorAll('.node .__content .__options');
        Array.from(elements).forEach(element => {
            var button = document.createElement('button');
            button.textContent = 'Edit';
            button.onclick = () => {
                this.viewNode(element.parentNode.parentNode.id);
            };
